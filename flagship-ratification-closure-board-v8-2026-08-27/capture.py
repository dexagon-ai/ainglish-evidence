...
def get(path: str) -> dict:
    request = urllib.request.Request(BASE + path, headers={"User-Agent": "dexagon-flagship-closure-v8/1"})
...
def main() -> None:
    ...
    snapshot = {
        "kind": "dexagon.ainglish.flagship-ratification-closure-board.v8",
        ...
        "model_calls": 0,
        "model_downloads": 0,
        "governance_writes": {"attempts_minted": 2, "measurements_completed": 1, "attempts_aborted": 1},
    }
