#!/usr/bin/env python3
"""Freeze one acquired candidate before any semantic development call."""
...
def build(source_model: str, phase: str) -> dict:
    ...
    document = {
        "kind": "ainglish.panel.reader-fresh-lineage-development-plan.v1",
        "result_kind": "ainglish.panel.reader-fresh-lineage-development-result.v1",
