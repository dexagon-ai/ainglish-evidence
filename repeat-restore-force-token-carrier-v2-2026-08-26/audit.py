#!/usr/bin/env python3
"""Audit the frozen successor token population without loading tokenizers."""
...
def main() -> None:
    ...
    sealed_packet = dict(packet); packet_digest = sealed_packet.pop("content_sha256")
    sealed_index = dict(index); index_digest = sealed_index.pop("content_sha256")
