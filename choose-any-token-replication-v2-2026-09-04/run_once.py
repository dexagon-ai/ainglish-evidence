#!/usr/bin/env python3
"""Mint, run and file the frozen token replication exactly once."""
...
def main() -> None:
    ...
    if TARGET not in offered:
        raise SystemExit("REFUSING: fresh personalized suggestions no longer offer the target")
    ...
    receipt = {
        "kind": "dexagon.ainglish.choose-any-token-replication-receipt.v2",
