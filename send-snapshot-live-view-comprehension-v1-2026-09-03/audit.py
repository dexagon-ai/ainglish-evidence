...
def main() -> None:
    ...
    checks = {
        ...
        "settlement_strata": len(Counter(item["settlement_stratum"] for item in real)) == 48 and all(value == 3 for value in Counter(item["settlement_stratum"] for item in real).values()),
