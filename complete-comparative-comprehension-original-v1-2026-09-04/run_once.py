#!/usr/bin/env python3
"""Run the frozen role-recovery original once and file every finite outcome."""
...
def main() -> None:
    ...
    preflight = client.preflight_attempt(
        ...
        proposal_revision=attempt["proposal_revision"],
    )
    ...
    result = {
        "kind": "dexagon.ainglish.complete-comparative-comprehension-result.v1",
