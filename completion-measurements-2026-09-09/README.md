...
| 6. Replacement / postpone | Replacement semantic review received with duplicate-row caveat. Postpone force mismatch identified and sent to both authors. | Replacement cost disagreement and postpone's source-scope/force correction need resolution before the planned full readers. |
