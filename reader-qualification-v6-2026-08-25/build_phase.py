#!/usr/bin/env python3
"""Freeze one v6 tranche after its source and wrapper digests exist locally."""
...
def main() -> None:
    ...
    spec = {
        "kind": f"ainglish.panel.reader-qualification-holdout.v6-{args.phase}",
        "result_kind": f"ainglish.panel.reader-qualification-holdout-result.v6-{args.phase}",
